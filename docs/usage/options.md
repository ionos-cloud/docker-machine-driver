...
| `--ionoscloud-disk-type`                | IONOS CLOUD Volume Disk-Type \(HDD, SSD, SSD Standard, SSD Premium, DAS, ESSENTIAL, BALANCED, PERFORMANCE\). If server type is CUBE this value is ignored and "DAS" is used, "DAS" cannot be used with ENTERPRISE servers                                                                                                                                                 |
