...
| `--ionoscloud-image` | Ionos Cloud Image Id or Alias. If Image Id is set, please make sure the disk type is in sync with the image type.\(ubuntu:latest, ubuntu:20.04\) |
