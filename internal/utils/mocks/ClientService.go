...
func (m *MockClientService) CreateNat(datacenterId, name string, publicIps []string, lansToGateways map[string][]string, subnet string) (*ionoscloud.NatGateway, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateNat", datacenterId, name, publicIps, lansToGateways, subnet)
...
func (mr *MockClientServiceMockRecorder) CreateNat(datacenterId, name, publicIps, lansToGateways, subnet interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "CreateNat", reflect.TypeOf((*MockClientService)(nil).CreateNat), datacenterId, name, publicIps, lansToGateways, subnet)
}
